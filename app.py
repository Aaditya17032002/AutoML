...
if choice == "ML":
    ...
    try:
        ...
        irrelevant_columns = [col for col in df.columns if not (col.lower().startswith("id") or col.lower().endswith("id")) and (not any(word in col.lower() for word in column_names))]
